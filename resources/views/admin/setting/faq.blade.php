                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin_page', ['params' => 'settings/faq']) }}" method="POST">
                        ...
                        @foreach ($faq_questions as $question)
                            <input type="hidden" name="codes[]" value="{{ $question->code ?? -1 }}" required readonly>
                            <input type="hidden" name="keys[]" value="{{ $question->key ?? 'faq_questions' }}" required
                                readonly>
                                            ...
                                            <div class="card-text">
                                                ...
                                                <div class="col-lg-12">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        name="language[{{ $item->optional_1 }}][value][]" id=""
