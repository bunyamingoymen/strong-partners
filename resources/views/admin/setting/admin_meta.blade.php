        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('admin_page', ['params' => 'settings/meta/admin']) }}" method="POST">
                        @csrf
                            ...
                            @foreach ($admin_meta as $item)
                                <div class="col-lg-8 mt-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2">
                                            <a href="{{ route('admin_page', ['params' => 'settings/meta/admin/delete']) }}?code={{ $item->code }}"
        ...
        function addNewMeta() {
            ...
            var html = `
                <div class="col-lg-8 mt-3" id="meta_${count}">
                    ...
                    <input type="hidden" id="key_${count}" class="meta_keys" name="keys[]" value="admin_meta" required readonly>
                    <div class="row">
                        <div class="col-lg-8">
                            <input type="text" id="value_${count}" name="values[]"
